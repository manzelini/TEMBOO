...
// Add the checkGist Choreo
var checkGistChoreo = temboo.addChoreo('jsCheckGist');

// Add inputs
checkGistChoreo.setInput('ID', 'yourValueHere');
...
checkGistChoreo.execute(showResult, showError);
</script>